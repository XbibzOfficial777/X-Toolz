...
.field private final f:Lk0/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILk0/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lk0/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v1, v2}, Lx/h;->b(ZLjava/lang/Object;)V

    sget-object v1, LT/j;->L2:[I
    ...
    invoke-static {p0, p1, v1}, Lh0/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Lk0/k;->b(Landroid/content/Context;II)Lk0/k$b;

    move-result-object p0

    invoke-virtual {p0}, Lk0/k$b;->m()Lk0/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILk0/k;Landroid/graphics/Rect;)V
...
.method c(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lk0/k;
    ...
    invoke-virtual {v0, p2, v2}, Lk0/g;->Y(FLandroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/W;->u0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
