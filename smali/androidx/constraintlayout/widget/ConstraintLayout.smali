...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;
...
.method private final k(I)Lp/e;
    .locals 1

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/widget/ConstraintLayout$b;->v0:Lp/e;
...
.method private q(Landroid/util/AttributeSet;II)V
    ...
    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;

    invoke-virtual {v0, p0}, Lp/e;->B0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lp/f;->V1(Lq/b$b;)V
    ...
    invoke-virtual {p1, p2}, Lp/f;->W1(I)V
...
.method private w()V
    ...
    invoke-virtual {p0, v2}, Landroidx/constraintlayout/widget/ConstraintLayout;->p(Landroid/view/View;)Lp/e;
    ...
    invoke-direct {p0, v3}, Landroidx/constraintlayout/widget/ConstraintLayout;->k(I)Lp/e;

    move-result-object v3

    invoke-virtual {v3, v4}, Lp/e;->C0(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_5
    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;

    invoke-virtual {v1}, Lp/m;->u1()V
    ...
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;
    ...
    iget-object v3, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->d(ZLandroid/view/View;Lp/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
...
.method private z(Lp/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;ILp/d$b;)V
    .locals 2
    ...
    iget-object v0, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->v0:Lp/e;

    invoke-virtual {v0, p4}, Lp/e;->K0(Z)V

    :cond_0
    invoke-virtual {p1, v1}, Lp/e;->o(Lp/d$b;)Lp/d;

    move-result-object v0

    invoke-virtual {p3, p5}, Lp/e;->o(Lp/d$b;)Lp/d;
    ...
    invoke-virtual {v0, p3, p5, p2, p4}, Lp/d;->b(Lp/d;IIZ)Z

    invoke-virtual {p1, p4}, Lp/e;->K0(Z)V

    sget-object p2, Lp/d$b;->c:Lp/d$b;

    invoke-virtual {p1, p2}, Lp/e;->o(Lp/d$b;)Lp/d;

    move-result-object p2

    invoke-virtual {p2}, Lp/d;->q()V
...
.method protected d(ZLandroid/view/View;Lp/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
    .locals 16
    ...
    invoke-virtual {v6, v1}, Lp/e;->j1(I)V
    ...
    invoke-virtual {v6, v1}, Lp/e;->T0(Z)V
    ...
    :cond_0
    invoke-virtual {v6, v0}, Lp/e;->B0(Ljava/lang/Object;)V
    ...
    iget-object v1, v10, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;

    invoke-virtual {v1}, Lp/f;->P1()Z

    move-result v1

    invoke-virtual {v0, v6, v1}, Landroidx/constraintlayout/widget/c;->j(Lp/e;Z)V
    ...
    invoke-virtual {v0, v3}, Lp/h;->z1(F)V
    ...
    invoke-virtual {v0, v1}, Lp/h;->x1(I)V
    ...
    invoke-virtual {v0, v2}, Lp/h;->y1(I)V
    ...
    invoke-virtual {v6, v0, v1, v2}, Lp/e;->l(Lp/e;FI)V
    ...
    sget-object v1, Lp/d$b;->b:Lp/d$b;

    sget-object v3, Lp/d$b;->d:Lp/d$b;
    ...
    sget-object v1, Lp/d$b;->d:Lp/d$b;
    ...
    sget-object v1, Lp/d$b;->e:Lp/d$b;
    ...
    sget-object v5, Lp/d$b;->f:Lp/d$b;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->z(Lp/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;ILp/d$b;)V
    ...
    sget-object v5, Lp/d$b;->c:Lp/d$b;
    ...
    invoke-virtual {v6, v15}, Lp/e;->M0(F)V
    ...
    invoke-virtual {v6, v1}, Lp/e;->d1(F)V
    ...
    invoke-virtual {v6, v0, v1}, Lp/e;->b1(II)V
    ...
    :goto_8
    invoke-virtual {v6, v0}, Lp/e;->P0(Lp/e$b;)V

    goto :goto_9

    :cond_15
    sget-object v0, Lp/e$b;->d:Lp/e$b;

    goto :goto_8

    :goto_9
    sget-object v0, Lp/d$b;->b:Lp/d$b;

    invoke-virtual {v6, v0}, Lp/e;->o(Lp/d$b;)Lp/d;
    ...
    sget-object v0, Lp/d$b;->d:Lp/d$b;
    ...
    invoke-virtual {v6, v9}, Lp/e;->k1(I)V
    ...
    invoke-virtual {v6, v0}, Lp/e;->k1(I)V
    ...
    :goto_b
    invoke-virtual {v6, v0}, Lp/e;->g1(Lp/e$b;)V
    ...
    :goto_c
    sget-object v0, Lp/d$b;->c:Lp/d$b;
    ...
    invoke-virtual {v6, v9}, Lp/e;->L0(I)V
    ...
    invoke-virtual {v6, v0}, Lp/e;->L0(I)V
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Lp/e;->Q0(IIIF)V
    ...
    invoke-virtual {v6, v0, v1, v2, v3}, Lp/e;->h1(IIIF)V
...
.method public getSceneString()Ljava/lang/String;
    ...
    iget-object v1, v1, Lp/e;->o:Ljava/lang/String;
    ...
    iput-object v1, v3, Lp/e;->o:Ljava/lang/String;
    ...
    iput-object v3, v1, Lp/e;->o:Ljava/lang/String;
    ...
    iget-object v5, v1, Lp/e;->o:Ljava/lang/String;

    invoke-virtual {v1, v5}, Lp/e;->C0(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;

    invoke-virtual {v5}, Lp/e;->t()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lp/m;->r1()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lp/e;->s()Ljava/lang/Object;
    ...
    iget-object v7, v5, Lp/e;->o:Ljava/lang/String;
    ...
    iput-object v6, v5, Lp/e;->o:Ljava/lang/String;
    ...
    iget-object v6, v5, Lp/e;->o:Ljava/lang/String;

    invoke-virtual {v5, v6}, Lp/e;->C0(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lp/f;->O(Ljava/lang/StringBuilder;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->v0:Lp/e;
    ...
    :cond_1
    invoke-virtual {v1}, Lp/e;->X()I

    move-result v0

    invoke-virtual {v1}, Lp/e;->Y()I
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v0, v2}, Lp/f;->Y1(Z)V
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroidx/constraintlayout/widget/ConstraintLayout;->v(Lp/f;III)V
    ...
    invoke-virtual {v0}, Lp/e;->x()I

    move-result v5

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;

    invoke-virtual {v0}, Lp/f;->Q1()Z

    move-result v6

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Lp/f;

    invoke-virtual {v0}, Lp/f;->O1()Z
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->p(Landroid/view/View;)Lp/e;
    ...
    iput-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->v0:Lp/e;
    ...
    invoke-virtual {v1, v0}, Lp/h;->A1(I)V
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Lp/m;->t1(Lp/e;)V
...
.method public final p(Landroid/view/View;)Lp/e;
    .locals 1
...
.method public setOptimizationLevel(I)V
    ...
    invoke-virtual {v0, p1}, Lp/f;->W1(I)V
...
.method protected v(Lp/f;III)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->y(Lp/f;IIII)V
    ...
    invoke-virtual/range {v7 .. v16}, Lp/f;->R1(IIIIIIIII)J
...
.method protected y(Lp/f;IIII)V
    .locals 7
    ...
    :cond_2
    sget-object p2, Lp/e$b;->b:Lp/e$b;
    ...
    :cond_a
    invoke-virtual {p1}, Lp/f;->N1()V

    :cond_b
    invoke-virtual {p1, v6}, Lp/e;->m1(I)V

    invoke-virtual {p1, v6}, Lp/e;->n1(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->f:I

    sub-int/2addr p4, v0

    invoke-virtual {p1, p4}, Lp/e;->X0(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->g:I

    sub-int/2addr p4, v1

    invoke-virtual {p1, p4}, Lp/e;->W0(I)V

    invoke-virtual {p1, v6}, Lp/e;->a1(I)V

    invoke-virtual {p1, v6}, Lp/e;->Z0(I)V

    invoke-virtual {p1, p2}, Lp/e;->P0(Lp/e$b;)V

    invoke-virtual {p1, p3}, Lp/e;->k1(I)V

    invoke-virtual {p1, v2}, Lp/e;->g1(Lp/e$b;)V
    ...
    invoke-virtual {p1, p2}, Lp/e;->Z0(I)V
