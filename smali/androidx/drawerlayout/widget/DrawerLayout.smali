...
.field private final h:LD/c;

.field private final i:Landroidx/drawerlayout/widget/DrawerLayout$i;

.field private final j:Landroidx/drawerlayout/widget/DrawerLayout$i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->K:Ly/L;
    ...
    new-instance v3, Landroidx/drawerlayout/widget/DrawerLayout$i;

    invoke-direct {v3, p0, v1}, Landroidx/drawerlayout/widget/DrawerLayout$i;-><init>(Landroidx/drawerlayout/widget/DrawerLayout;I)V

    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:Landroidx/drawerlayout/widget/DrawerLayout$i;

    new-instance v1, Landroidx/drawerlayout/widget/DrawerLayout$i;

    const/4 v4, 0x5

    invoke-direct {v1, p0, v4}, Landroidx/drawerlayout/widget/DrawerLayout$i;-><init>(Landroidx/drawerlayout/widget/DrawerLayout;I)V

    iput-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Landroidx/drawerlayout/widget/DrawerLayout$i;

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-static {p0, v4, v3}, LD/c;->n(Landroid/view/ViewGroup;FLD/c$c;)LD/c;

    move-result-object v5

    iput-object v5, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {v5, v0}, LD/c;->M(I)V

    invoke-virtual {v5, v2}, LD/c;->N(F)V

    invoke-virtual {v3, v5}, Landroidx/drawerlayout/widget/DrawerLayout$i;->q(LD/c;)V

    invoke-static {p0, v4, v1}, LD/c;->n(Landroid/view/ViewGroup;FLD/c$c;)LD/c;

    move-result-object v3

    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, LD/c;->M(I)V

    invoke-virtual {v3, v2}, LD/c;->N(F)V

    invoke-virtual {v1, v3}, Landroidx/drawerlayout/widget/DrawerLayout$i;->q(LD/c;)V

    invoke-virtual {p0, v0}, Landroid/view/View;->setFocusableInTouchMode(Z)V

    invoke-static {p0, v0}, Landroidx/core/view/W;->y0(Landroid/view/View;I)V
    ...
    invoke-static {p0, v0}, Landroidx/core/view/W;->q0(Landroid/view/View;Landroidx/core/view/a;)V
...
.method private V(Landroid/view/View;)V
    ...
    sget-object v0, Ly/I$a;->y:Ly/I$a;

    invoke-virtual {v0}, Ly/I$a;->b()I

    move-result v1

    invoke-static {p1, v1}, Landroidx/core/view/W;->k0(Landroid/view/View;I)V
    ...
    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->K:Ly/L;

    invoke-static {p1, v0, v1, v2}, Landroidx/core/view/W;->m0(Landroid/view/View;Ly/I$a;Ljava/lang/CharSequence;Ly/L;)V
...
.method private W(Landroid/view/View;Z)V
    ...
    :goto_1
    invoke-static {v2, v3}, Landroidx/core/view/W;->y0(Landroid/view/View;I)V
...
.method E(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroidx/core/view/W;->C(Landroid/view/View;)I
...
.method public N(Landroid/view/View;Z)V
    ...
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v0

    invoke-virtual {p2, p1, v1, v0}, LD/c;->Q(Landroid/view/View;II)Z

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;
    ...
    invoke-virtual {p2, p1, v0, v1}, LD/c;->Q(Landroid/view/View;II)Z
...
.method X(ILandroid/view/View;)V
    ...
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {v0}, LD/c;->A()I

    move-result v0

    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;

    invoke-virtual {v1}, LD/c;->A()I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    :goto_0
    invoke-static {p1, p2}, Landroidx/core/view/W;->y0(Landroid/view/View;I)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/W;->q0(Landroid/view/View;Landroidx/core/view/a;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v1}, LD/c;->m(Z)Z

    move-result v0

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;

    invoke-virtual {v2, v1}, LD/c;->m(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {v8}, LD/c;->x()I
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;

    invoke-virtual {v10}, LD/c;->x()I
...
.method i(Z)V
    ...
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;
    ...
    invoke-virtual {v7, v4, v6, v8}, LD/c;->Q(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;
    ...
    invoke-virtual {v6, v4, v7, v8}, LD/c;->Q(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:Landroidx/drawerlayout/widget/DrawerLayout$i;

    invoke-virtual {p1}, Landroidx/drawerlayout/widget/DrawerLayout$i;->p()V

    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Landroidx/drawerlayout/widget/DrawerLayout$i;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {v1, p1}, LD/c;->P(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;

    invoke-virtual {v2, p1}, LD/c;->P(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {p1, v4}, LD/c;->d(I)Z
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, LD/c;->t(II)Landroid/view/View;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, LF/a;->a(Landroidx/drawerlayout/widget/DrawerLayout;)Landroid/view/WindowInsets;

    move-result-object v1

    if-eqz v1, :cond_c

    invoke-static {v1}, Landroidx/core/view/w0;->w(Landroid/view/WindowInsets;)Landroidx/core/view/w0;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/core/view/w0;->h()Landroidx/core/graphics/f;

    move-result-object v1

    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    invoke-virtual {v2}, LD/c;->w()I
    ...
    invoke-virtual {v2, v3}, LD/c;->L(I)V

    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;
    ...
    invoke-virtual {v2, v1}, LD/c;->L(I)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v12}, Landroidx/core/view/W;->z(Landroid/view/View;)Z
    ...
    invoke-static {v12}, Landroidx/core/view/W;->w(Landroid/view/View;)F
    ...
    invoke-static {v12, v14}, Landroidx/core/view/W;->x0(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, LD/c;->F(Landroid/view/MotionEvent;)V

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:LD/c;
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:LD/c;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, LD/c;->t(II)Landroid/view/View;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v1}, Landroidx/core/view/W;->x0(Landroid/view/View;F)V
