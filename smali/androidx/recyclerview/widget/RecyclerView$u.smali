...
.method private H(Landroidx/recyclerview/widget/RecyclerView$C;IIJ)Z
    ...
    invoke-virtual {p4, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$g;->a(Landroidx/recyclerview/widget/RecyclerView$C;I)V
...
.method private b(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->n0:Landroidx/recyclerview/widget/l;
...
.method C(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/RecyclerView$g;->n(Landroidx/recyclerview/widget/RecyclerView$C;)Z
...
.method I(IZJ)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual {v6, v1}, Landroidx/recyclerview/widget/RecyclerView$u;->L(Landroidx/recyclerview/widget/RecyclerView$C;)Z
    ...
    invoke-virtual {v1, v5}, Landroidx/recyclerview/widget/RecyclerView$C;->b(I)V

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->w()Z
    ...
    iget-object v9, v1, Landroidx/recyclerview/widget/RecyclerView$C;->a:Landroid/view/View;

    invoke-virtual {v5, v9, v8}, Landroidx/recyclerview/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->K()V
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->e()V

    :cond_3
    :goto_1
    invoke-virtual {v6, v1}, Landroidx/recyclerview/widget/RecyclerView$u;->C(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v6, v10, v11, v9, v0}, Landroidx/recyclerview/widget/RecyclerView$u;->l(JIZ)Landroidx/recyclerview/widget/RecyclerView$C;

    move-result-object v1

    if-eqz v1, :cond_7

    iput v5, v1, Landroidx/recyclerview/widget/RecyclerView$C;->c:I
    ...
    invoke-virtual {v0, v9}, Landroidx/recyclerview/widget/RecyclerView$t;->f(I)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-direct {v6, v0}, Landroidx/recyclerview/widget/RecyclerView$u;->r(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v5, v2, v9}, Landroidx/recyclerview/widget/RecyclerView$g;->b(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    iget-object v5, v2, Landroidx/recyclerview/widget/RecyclerView$C;->a:Landroid/view/View;
    ...
    iput-object v10, v2, Landroidx/recyclerview/widget/RecyclerView$C;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v9, v0}, Landroidx/recyclerview/widget/RecyclerView$C;->p(I)Z

    move-result v1

    if-eqz v1, :cond_e

    invoke-virtual {v9, v8, v0}, Landroidx/recyclerview/widget/RecyclerView$C;->F(II)V
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->o()Ljava/util/List;
    ...
    invoke-virtual {v1, v9, v0}, Landroidx/recyclerview/widget/RecyclerView;->Q0(Landroidx/recyclerview/widget/RecyclerView$C;Landroidx/recyclerview/widget/RecyclerView$l$b;)V
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->s()Z

    move-result v0

    if-eqz v0, :cond_f

    iput v3, v9, Landroidx/recyclerview/widget/RecyclerView$C;->g:I
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->z()Z

    move-result v0

    if-nez v0, :cond_11

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->t()Z
    ...
    :goto_7
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView$C;->a:Landroid/view/View;
    ...
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView$C;->a:Landroid/view/View;
...
.method a(Landroidx/recyclerview/widget/RecyclerView$C;Z)V
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->n0:Landroidx/recyclerview/widget/l;
...
.method g(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$g;->q(Landroidx/recyclerview/widget/RecyclerView$C;)V
...
.method m(IZ)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-static {v0}, Landroidx/recyclerview/widget/RecyclerView;->f0(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$C;
