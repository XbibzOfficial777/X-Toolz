...
.method private g0(Z)V
    ...
    invoke-static {p1, v1}, Landroidx/core/view/a0;->l(Landroid/view/ViewConfiguration;Landroid/content/Context;)Z
...
.method private i(Z)V
    ...
    :cond_1
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/j;->n(Z)V
...
.method private j(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v2}, Landroidx/appcompat/view/menu/j;->c()I
    ...
    invoke-interface {v2, v1}, Landroidx/appcompat/view/menu/j;->h(Landroid/os/Parcelable;)V
...
.method private k(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v3}, Landroidx/appcompat/view/menu/j;->c()I

    move-result v2

    if-lez v2, :cond_1

    invoke-interface {v3}, Landroidx/appcompat/view/menu/j;->e()Landroid/os/Parcelable;
...
.method private l(Landroidx/appcompat/view/menu/m;Landroidx/appcompat/view/menu/j;)Z
    ...
    invoke-interface {p2, p1}, Landroidx/appcompat/view/menu/j;->m(Landroidx/appcompat/view/menu/m;)Z
    ...
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/j;->m(Landroidx/appcompat/view/menu/m;)Z
