...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->l:Landroidx/appcompat/widget/U;
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->G()I
...
.method private C()Landroidx/appcompat/widget/V;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->l:Landroidx/appcompat/widget/U;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/V;->U(Landroidx/appcompat/widget/U;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/T;->L(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/T;->K(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/T;->D(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->n:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/T;->G(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/T;->J(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/T;->I(I)V

    return-object v0
.end method

.method private D(Landroidx/appcompat/view/menu/e;)I
    .locals 3
...
.method private E(Landroidx/appcompat/view/menu/e;Landroidx/appcompat/view/menu/e;)Landroid/view/MenuItem;
    .locals 4
...
.method private F(Landroidx/appcompat/view/menu/b$d;Landroidx/appcompat/view/menu/e;)Landroid/view/View;
    .locals 7

    iget-object v0, p1, Landroidx/appcompat/view/menu/b$d;->b:Landroidx/appcompat/view/menu/e;

    invoke-direct {p0, v0, p2}, Landroidx/appcompat/view/menu/b;->E(Landroidx/appcompat/view/menu/e;Landroidx/appcompat/view/menu/e;)Landroid/view/MenuItem;
...
.method private I(Landroidx/appcompat/view/menu/e;)V
    .locals 14
    ...
    invoke-static {v1, v5, v2, v4}, Landroidx/appcompat/view/menu/h;->r(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v2

    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->C()Landroidx/appcompat/widget/V;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/T;->o(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/T;->F(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->n:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/T;->G(I)V
    ...
    invoke-direct {p0, v1, p1}, Landroidx/appcompat/view/menu/b;->F(Landroidx/appcompat/view/menu/b$d;Landroidx/appcompat/view/menu/e;)Landroid/view/View;
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/V;->V(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/V;->S(Ljava/lang/Object;)V

    invoke-direct {p0, v2}, Landroidx/appcompat/view/menu/b;->H(I)I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/T;->D(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/T;->c(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/T;->N(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/T;->n(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/T;->c(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/T;->n(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/T;->H(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Landroidx/appcompat/widget/V;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->i:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/T;->f()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/T;->k()Landroid/widget/ListView;
...
.method public a(Landroidx/appcompat/view/menu/e;Z)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/view/menu/b;->D(Landroidx/appcompat/view/menu/e;)I
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/V;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/V;->T(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/V;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/T;->E(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/V;
...
.method public b()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/T;->b()Z
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/V;

    invoke-virtual {v3}, Landroidx/appcompat/widget/T;->b()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/V;
...
.method public f()V
    ...
    invoke-direct {p0, v1}, Landroidx/appcompat/view/menu/b;->I(Landroidx/appcompat/view/menu/e;)V
...
.method public l(Landroidx/appcompat/view/menu/j$a;)V
    .locals 0
...
.method public n(Z)V
    ...
    invoke-static {v0}, Landroidx/appcompat/view/menu/h;->B(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/d;
...
.method public o(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/view/menu/b;->I(Landroidx/appcompat/view/menu/e;)V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/V;

    invoke-virtual {v4}, Landroidx/appcompat/widget/T;->b()Z
