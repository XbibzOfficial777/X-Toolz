...
.method private a()Landroidx/appcompat/view/menu/h;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->o(Landroidx/appcompat/view/menu/e;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->x(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->s(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->u(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/i;->g:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->v(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->y(Z)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/h;->w(I)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/h;->z(I)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->t(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Li/e;->f()V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/h;->u(Z)V
...
.method public j(Landroidx/appcompat/view/menu/j$a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/j;->l(Landroidx/appcompat/view/menu/j$a;)V
