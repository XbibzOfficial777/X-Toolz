.class Landroidx/appcompat/app/i$n;
...
# instance fields
.field private b:Landroidx/appcompat/app/i$g;
...
# direct methods
.method constructor <init>(Landroidx/appcompat/app/i;Landroid/view/Window$Callback;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/app/i$n;->f:Landroidx/appcompat/app/i;
...
.method public b(Landroid/view/Window$Callback;Landroid/view/KeyEvent;)Z
    ...
    :try_start_0
    iput-boolean v0, p0, Landroidx/appcompat/app/i$n;->d:Z
    ...
    iput-boolean v1, p0, Landroidx/appcompat/app/i$n;->d:Z
...
.method public c(Landroid/view/Window$Callback;)V
    ...
    :try_start_0
    iput-boolean v0, p0, Landroidx/appcompat/app/i$n;->c:Z

    invoke-interface {p1}, Landroid/view/Window$Callback;->onContentChanged()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-boolean v1, p0, Landroidx/appcompat/app/i$n;->c:Z
...
.method public d(Landroid/view/Window$Callback;ILandroid/view/Menu;)V
    ...
    :try_start_0
    iput-boolean v0, p0, Landroidx/appcompat/app/i$n;->e:Z

    invoke-interface {p1, p2, p3}, Landroid/view/Window$Callback;->onPanelClosed(ILandroid/view/Menu;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-boolean v1, p0, Landroidx/appcompat/app/i$n;->e:Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/i$n;->d:Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/app/i$n;->f:Landroidx/appcompat/app/i;

    invoke-virtual {v0, p1}, Landroidx/appcompat/app/i;->h0(Landroid/view/KeyEvent;)Z
...
.method public dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/appcompat/app/i;->G0(ILandroid/view/KeyEvent;)Z
...
.method e(Landroidx/appcompat/app/i$g;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/app/i$n;->b:Landroidx/appcompat/app/i$g;
...
.method final f(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, Landroidx/appcompat/app/i$n;->f:Landroidx/appcompat/app/i;

    iget-object v1, v1, Landroidx/appcompat/app/i;->k:Landroid/content/Context;

    invoke-direct {v0, v1, p1}, Landroidx/appcompat/view/f$a;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    iget-object p1, p0, Landroidx/appcompat/app/i$n;->f:Landroidx/appcompat/app/i;

    invoke-virtual {p1, v0}, Landroidx/appcompat/app/i;->X0(Landroidx/appcompat/view/b$a;)Landroidx/appcompat/view/b;
...
.method public onContentChanged()V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/i$n;->c:Z
...
.method public onCreatePanelView(I)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/i$n;->b:Landroidx/appcompat/app/i$g;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Landroidx/appcompat/app/i$g;->onCreatePanelView(I)Landroid/view/View;
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    iget-object p2, p0, Landroidx/appcompat/app/i$n;->f:Landroidx/appcompat/app/i;

    invoke-virtual {p2, p1}, Landroidx/appcompat/app/i;->J0(I)V
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/i$n;->e:Z
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/app/i;->K0(I)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    :cond_2
    iget-object v3, p0, Landroidx/appcompat/app/i$n;->b:Landroidx/appcompat/app/i$g;

    if-eqz v3, :cond_3

    invoke-interface {v3, p1}, Landroidx/appcompat/app/i$g;->a(I)Z
...
.method public onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/app/i;->t0(IZ)Landroidx/appcompat/app/i$s;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/app/i;->B0()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, Landroidx/appcompat/app/i$n;->f(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
