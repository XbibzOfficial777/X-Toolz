...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/z;->b:[Ljava/lang/Class;
    ...
    sput-object v0, Landroidx/appcompat/app/z;->c:[I
    ...
    sput-object v0, Landroidx/appcompat/app/z;->e:[I
    ...
    sput-object v0, Landroidx/appcompat/app/z;->f:[I
    ...
    sput-object v0, Landroidx/appcompat/app/z;->g:[Ljava/lang/String;

    new-instance v0, Ll/g;

    invoke-direct {v0}, Ll/g;-><init>()V

    sput-object v0, Landroidx/appcompat/app/z;->h:Ll/g;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/app/z;->a:[Ljava/lang/Object;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v0, Landroidx/appcompat/app/z;->d:[I
    ...
    invoke-static {p2, v2}, Landroidx/core/view/W;->r0(Landroid/view/View;Z)V

    :cond_1
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Landroidx/appcompat/app/z;->e:[I
    ...
    invoke-static {p2, v2}, Landroidx/core/view/W;->t0(Landroid/view/View;Ljava/lang/CharSequence;)V

    :cond_2
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Landroidx/appcompat/app/z;->f:[I
    ...
    invoke-static {p2, p3}, Landroidx/core/view/W;->E0(Landroid/view/View;Z)V
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v1, Landroidx/appcompat/app/z;->c:[I
    ...
    new-instance v1, Landroidx/appcompat/app/z$a;

    invoke-direct {v1, p1, v0}, Landroidx/appcompat/app/z$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/z;->h:Ll/g;
    ...
    sget-object p3, Landroidx/appcompat/app/z;->b:[Ljava/lang/Class;
    ...
    iget-object p1, p0, Landroidx/appcompat/app/z;->a:[Ljava/lang/Object;
...
.method private t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/appcompat/app/z;->a:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Landroidx/appcompat/app/z;->g:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/z;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/z;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget-object p2, p0, Landroidx/appcompat/app/z;->a:[Ljava/lang/Object;
...
.method protected o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/F;
    .locals 1
...
.method protected p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/K;
    .locals 1
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/z;->u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/z;->q(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;

    move-result-object p5

    :goto_2
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/z;->v(Landroid/view/View;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/l;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/K;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/A;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/y;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/F;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/h;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/z;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/z;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, p5, p4}, Landroidx/appcompat/app/z;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    invoke-direct {p0, p1, p5, p4}, Landroidx/appcompat/app/z;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
