...
.method public constructor <init>(Landroidx/appcompat/widget/A;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/T;->D(Landroid/view/View;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/T;->J(Z)V

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/T;->P(I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/T;->L(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic S(Landroidx/appcompat/widget/A$f;)V
    ...
    invoke-super {p0}, Landroidx/appcompat/widget/T;->f()V
...
.method T()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/T;->i()Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/T;->F(I)V
    ...
    :cond_4
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/T;->F(I)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/T;->z()I
    ...
    :goto_3
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/T;->c(I)V
...
.method public e(II)V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/T;->I(I)V

    invoke-super {p0}, Landroidx/appcompat/widget/T;->f()V

    invoke-virtual {p0}, Landroidx/appcompat/widget/T;->k()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/T;->Q(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/T;->K(Landroid/widget/PopupWindow$OnDismissListener;)V
