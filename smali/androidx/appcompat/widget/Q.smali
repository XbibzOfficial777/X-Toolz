...
.method private f(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/Q;->b()Li/e;
    ...
    :cond_0
    invoke-interface {v1}, Li/e;->k()Landroid/widget/ListView;
    ...
    invoke-direct {p0, v0, v3}, Landroidx/appcompat/widget/Q;->i(Landroid/view/View;Landroid/view/MotionEvent;)Z

    invoke-direct {p0, v1, v3}, Landroidx/appcompat/widget/Q;->j(Landroid/view/View;Landroid/view/MotionEvent;)Z

    iget v0, p0, Landroidx/appcompat/widget/Q;->h:I

    invoke-virtual {v1, v3, v0}, Landroidx/appcompat/widget/O;->e(Landroid/view/MotionEvent;I)Z
...
.method private g(Landroid/view/MotionEvent;)Z
    ...
    iget v1, p0, Landroidx/appcompat/widget/Q;->a:F

    invoke-static {v0, v4, p1, v1}, Landroidx/appcompat/widget/Q;->h(Landroid/view/View;FFF)Z
    ...
    new-instance p1, Landroidx/appcompat/widget/Q$a;

    invoke-direct {p1, p0}, Landroidx/appcompat/widget/Q$a;-><init>(Landroidx/appcompat/widget/Q;)V

    iput-object p1, p0, Landroidx/appcompat/widget/Q;->e:Ljava/lang/Runnable;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Q;->f:Ljava/lang/Runnable;

    if-nez p1, :cond_5

    new-instance p1, Landroidx/appcompat/widget/Q$b;

    invoke-direct {p1, p0}, Landroidx/appcompat/widget/Q$b;-><init>(Landroidx/appcompat/widget/Q;)V

    iput-object p1, p0, Landroidx/appcompat/widget/Q;->f:Ljava/lang/Runnable;

    :cond_5
    iget-object p1, p0, Landroidx/appcompat/widget/Q;->f:Ljava/lang/Runnable;

    iget v1, p0, Landroidx/appcompat/widget/Q;->c:I
...
.method private i(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Q;->i:[I
...
.method e()V
    ...
    iput-boolean v2, p0, Landroidx/appcompat/widget/Q;->g:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/Q;->f(Landroid/view/MotionEvent;)Z
    ...
    :cond_2
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/Q;->g(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/Q;->d:Landroid/view/View;
