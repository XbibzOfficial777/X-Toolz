...
.method private static w(Landroidx/transition/k;)Z
    ...
    invoke-virtual {p0}, Landroidx/transition/k;->A()Ljava/util/List;

    move-result-object v0

    invoke-static {v0}, Landroidx/fragment/app/H;->i(Ljava/util/List;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Landroidx/transition/k;->B()Ljava/util/List;
    ...
    invoke-static {p0}, Landroidx/fragment/app/H;->i(Ljava/util/List;)Z
...
.method private static synthetic x(Ljava/lang/Runnable;Landroidx/transition/k;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1}, Landroidx/transition/k;->f()V
...
.method public b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p1}, Landroidx/transition/v;->k0()I
    ...
    invoke-virtual {p1, v1}, Landroidx/transition/v;->j0(I)Landroidx/transition/k;
    ...
    invoke-virtual {p1}, Landroidx/transition/k;->D()Ljava/util/List;
...
.method public f(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Landroidx/transition/k;->m()Landroidx/transition/k;
...
.method public j(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1}, Landroidx/transition/v;->h0(Landroidx/transition/k;)Landroidx/transition/v;

    move-result-object p1

    invoke-virtual {p1, p2}, Landroidx/transition/v;->h0(Landroidx/transition/k;)Landroidx/transition/v;

    move-result-object p1

    const/4 p2, 0x1

    invoke-virtual {p1, p2}, Landroidx/transition/v;->p0(I)Landroidx/transition/v;
    ...
    new-instance p2, Landroidx/transition/v;

    invoke-direct {p2}, Landroidx/transition/v;-><init>()V

    if-eqz p1, :cond_3

    invoke-virtual {p2, p1}, Landroidx/transition/v;->h0(Landroidx/transition/k;)Landroidx/transition/v;

    :cond_3
    invoke-virtual {p2, p3}, Landroidx/transition/v;->h0(Landroidx/transition/k;)Landroidx/transition/v;
...
.method public k(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2}, Landroidx/transition/v;->h0(Landroidx/transition/k;)Landroidx/transition/v;
    ...
    invoke-virtual {v0, p3}, Landroidx/transition/v;->h0(Landroidx/transition/k;)Landroidx/transition/v;
...
.method public p(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p2, v0}, Landroidx/fragment/app/H;->h(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, p2}, Landroidx/transition/k;->Y(Landroidx/transition/k$e;)V

    :cond_0
    return-void
.end method

.method public q(Landroidx/fragment/app/Fragment;Ljava/lang/Object;Landroidx/core/os/a;Ljava/lang/Runnable;)V
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/e;->z(Landroidx/fragment/app/Fragment;Ljava/lang/Object;Landroidx/core/os/a;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public s(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-static {v0, v3}, Landroidx/fragment/app/H;->d(Ljava/util/List;Landroid/view/View;)V
...
.method public y(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/transition/k;->T(Landroid/view/View;)Landroidx/transition/k;
...
.method public z(Landroidx/fragment/app/Fragment;Ljava/lang/Object;Landroidx/core/os/a;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    .locals 0
    ...
    invoke-virtual {p3, p1}, Landroidx/core/os/a;->b(Landroidx/core/os/a$a;)V
