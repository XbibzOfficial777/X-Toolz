...
.method private a(Landroid/content/Context;Lw/f;)Landroidx/emoji2/text/f$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/k;-><init>(Landroid/content/Context;Lw/f;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/f$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/d$a;->h(Landroid/content/Context;)Lw/f;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/d$a;->a(Landroid/content/Context;Lw/f;)Landroidx/emoji2/text/f$c;
...
.method h(Landroid/content/Context;)Lw/f;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/d$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lw/f;
