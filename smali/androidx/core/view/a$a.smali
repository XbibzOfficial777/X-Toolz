...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Ly/J;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Ly/J;->e()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p1}, Landroidx/core/view/W;->X(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Ly/I;->D0(Z)V

    invoke-static {p1}, Landroidx/core/view/W;->S(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Ly/I;->v0(Z)V

    invoke-static {p1}, Landroidx/core/view/W;->q(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Ly/I;->A0(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/W;->K(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Ly/I;->J0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Ly/I;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Ly/I;->f(Ljava/lang/CharSequence;Landroid/view/View;)V
